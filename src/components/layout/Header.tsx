      ...
      <div className='ml-auto flex items-center gap-4'>
            ...
            <div className='max-h-[300px] overflow-y-auto'>
              ...
              >
                ...
                <div className='flex-1 min-w-0'>
                  ...
                  <p className='text-xs text-muted-foreground truncate'>
                    Necesito información sobre el nuevo sistema de reportes que
                    implementaron...
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className='flex-1 min-w-0'>
                  ...
                  <p className='text-xs text-muted-foreground truncate'>
                    Hola, ¿podrías revisar el documento que te envié la semana
                    pasada?
                  </p>
                </div>
              </div>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align='end' className='w-56 white-on-black-card'>
            <DropdownMenuLabel className='highlight-text'>
              Mi Cuenta
            </DropdownMenuLabel>
